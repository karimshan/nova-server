...
public class AnimationDefinition {
	...
	private static final ConcurrentHashMap<Integer, AnimationDefinition> animDefs = new ConcurrentHashMap<Integer, AnimationDefinition>();
	...
	public static final AnimationDefinition get(int emoteId) {
		AnimationDefinition defs = animDefs.get(emoteId);
		if (defs != null)
			return defs;
		byte[] data = Cache.INSTANCE.getIndices()[20].getFile(emoteId >>> 7,
				emoteId & 0x7f);
	...
	/**
	 * Returns the number of seconds it takes to finish the emote
	 * @return
	 */
	public double getSeconds() {
		return ((double) getEmoteTime() / 1000);
	}
