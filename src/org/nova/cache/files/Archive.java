...
import org.nova.cache.utility.bzip2.BZip2Compressor;
import org.nova.cache.utility.bzip2.BZip2Decompressor;
import org.nova.cache.utility.crc32.CRC32HGenerator;
import org.nova.cache.utility.gzip.GZipCompressor;
import org.nova.cache.utility.gzip.GZipDecompressor;
...
public class Archive {
	...
	public byte[] compress() {
		...
		stream.setOffset(0);
		stream.setBytes(compressed, 0, compressed.length);
		return compressed;
	}
	...
	private void decompress(byte[] archive) {
		...
		if(compressedLength < 0 || compressedLength > CacheConstants.MAX_VALID_ARCHIVE_LENGTH)
