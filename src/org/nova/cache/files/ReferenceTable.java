...
public final class ReferenceTable {
	...
	public void deleteArchive(int index, int id) {
		validArchiveIds = ArrayUtils.destroyElement(validArchiveIds, id);
		archives[id] = null;
		Cache.INSTANCE.getIndices()[index].rewriteTable();
		sortTable();
	}
