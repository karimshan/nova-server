...
public final class IndexedColorImageFile {
	...
	public IndexedColorImageFile(BufferedImage... images) {
        ...
        public IndexedColorImageFile(Cache cache, int archiveId, int fileId) {
            this(cache, CacheConstants.SPRITES_INDEX, archiveId, fileId);
        }
        
        /*
         * 
         */
        public IndexedColorImageFile(Cache cache, int idx, int archiveId, int fileId) {
            decodeArchive(cache, idx, archiveId, fileId);
        }
	
        public void decodeArchive(Cache cache, int idx, int archiveId, int fileId) {
	...
	public byte[] encodeFile() {
		...
		stream.setOffset(0);
		stream.setBytes(container, 0, container.length);
		return container;
	}
