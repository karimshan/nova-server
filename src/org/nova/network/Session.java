...
import org.nova.network.decoders.ClientPacketsDecoder;
import org.nova.network.decoders.Decoder;
import org.nova.network.decoders.GrabPacketsDecoder;
import org.nova.network.decoders.LoginPacketsDecoder;
import org.nova.network.decoders.packets.PacketDecoder;
import org.nova.network.encoders.Encoder;
import org.nova.network.encoders.GrabPacketsEncoder;
import org.nova.network.encoders.LoginPacketsEncoder;
...
public class Session {
	...
	public Session(Channel channel) {
		...
		if(Punishments.isIPBanned(getIP())) {
			channel.disconnect();
			return;
	...
	public final void setDecoder(int stage, Object attachement) {
		...
		case 2:
			...
			break;
		case 3:
			decoder = new PacketDecoder(this, (Player) attachement);
			break;
		case -1:
		default:
			decoder = null;
	...
	public final void setEncoder(int stage, Object attachement) {
		...
		case 1:
			...
			break;
		case 2:
			encoder = new PacketSender(this, (Player) attachement);
			break;
		case -1:
		default:
			encoder = null;
	...
	public PacketSender getWorldPackets() {
		return (PacketSender) encoder;
	}
