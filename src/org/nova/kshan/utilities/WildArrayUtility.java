...
public class WildArrayUtility {
	...
	public static Integer[] range(int start, int end, int increment) {
		Integer[] a = new Integer[Math.abs(start - end) / increment];
		int index = 0;
		if (start < end) {
	...
	/**
	 * Returns the index of the specified {@code o} argument within the specified {@code a} Array.
	 * If there is no index, -1 is returned instead.
	 * 
	 * @param o
