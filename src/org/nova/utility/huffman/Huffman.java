package org.nova.utility.huffman;
...
public final class Huffman {
	...
	public static final void init() {
		byte[] huffmanFile = Cache.INSTANCE.getIndices()[10].getFile(Cache.INSTANCE
				.getIndices()[10].getArchiveId("huffman"));
	...
	public static final String readEncryptedMessage(int maxLength,
		...
		try {
			...
			String message = Misc.getUnformatedMessage(messageDataLength, 0,
					messageData);
			return message;
