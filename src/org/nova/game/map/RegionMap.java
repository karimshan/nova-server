...
public class RegionMap {
	...
	if (x >= 64 || y >= 64 || x < 0 || y < 0) {
	    ...
	    if (clipedOnly)
		Game.getRegion(tile.getRegionId()).forceGetRegionMapClipedOnly().setMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    else
		Game.getRegion(tile.getRegionId()).forceGetRegionMap().setMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    return;
	}
	...
	if (x >= 64 || y >= 64 || x < 0 || y < 0) {
	    ...
	    int newRegionY = (regionId & 0xff) * 64;
	    if (clipedOnly)
		Game.getRegion(tile.getRegionId()).forceGetRegionMapClipedOnly().addMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    else
		Game.getRegion(tile.getRegionId()).forceGetRegionMap().addMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    return;
	}
	...
	if (x >= 64 || y >= 64 || x < 0 || y < 0) {
	    ...
	    int newRegionY = (regionId & 0xff) * 64;
	    if (clipedOnly)
		Game.getRegion(tile.getRegionId()).forceGetRegionMapClipedOnly().removeMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    else
		Game.getRegion(tile.getRegionId()).forceGetRegionMap().removeMask(plane, tile.getX() - newRegionX, tile.getY() - newRegionY, mask);
	    return;
	}
	masks[plane][x][y] &= (~mask);
    }
