...
*
*/
public class TeleportMinigame extends MatrixDialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (componentId == 1) {
			Magic.sendNormalTeleportSpell(player, 0, 0,
					new Location(3366, 3266, 0));
		} else if (componentId == 2) {
		Magic.sendNormalTeleportSpell(player, 0, 0,
					new Location(2443, 3089, 0));
		} else if (componentId == 3) {
		Magic.sendNormalTeleportSpell(player, 0, 0,
					new Location(1886, 3178, 0));
		} else if (componentId == 4) {
		Magic.sendNormalTeleportSpell(player, 0, 0,
					new Location(3366, 3083, 0));
		} else if (componentId == 5) {
		Magic.sendNormalTeleportSpell(player, 0, 0,
					new Location(3447, 3697, 0));
		} else {
			end();
	}
	}
