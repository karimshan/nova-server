...
//				player.interfaces().sendInterface(13);
//				player.packets().sendInterface(true, 13, 5, 759);
//				player.packets().sendConfigByFile(1010, -1);
//				player.packets().sendIComponentText(13, 27, "Bank of " + Constants.SERVER_NAME);
...
//			player.interfaces().sendInterface(14);
//			player.packets().sendGlobalConfig(98, 1);
//		} else if (player.getSetPin() == false) {
//			player.interfaces().sendInterface(14);
//			player.packets().sendGlobalConfig(98, 0);
//		}
//	}
//	
//	public void setPlayerBankPin() {
//		player.packets().sendIComponentText(14, 32, "Do you really wish to set a PIN on your bank account?");
//		player.packets().sendIComponentText(14, 34, "Yes, I really want a bank PIN. I will never forget it!");
//		player.packets().sendIComponentText(14, 36, "No, I might forget it!");
//		player.interfaces().sendInterface(14);
//		player.packets().sendGlobalConfig(98, -1);
//	}
//	
...
//						 player.interfaces().sendInterface(13);
//						 player.packets().sendConfigByFile(1010, -1);
//						 player.packets().sendMessage("Please enter your pin again for confirmation.");
...
//							player.packets().sendMessage("The confirmation pin you entered did not match the original.");
...
//						player.closeInterfaces();
//						if (player.getTemporaryAttributtes().get("delete_pin") != null) {
//							player.packets().sendMessage("You have successfully removed your bank pin.");
//							player.getTemporaryAttributtes().remove("confirm_last");
//							player.getTemporaryAttributtes().remove("confirm_bank_pin");
//							player.getTemporaryAttributtes().remove("delete_pin");
//							for (int i = 0; i < 4; i++) {
...
//								player.getConfirmPin()[i] = 0;
//							}
//							player.setSetPin(false);
//							return;
//						} else {
//							for (int i = 0; i < 4; i++) {
//								player.getConfirmPin()[i] = 0;
//							}
//							player.packets().sendMessage("You have successfully set your bank pin.");
//							player.getTemporaryAttributtes().remove("confirm_last");
//							player.getTemporaryAttributtes().remove("confirm_bank_pin");
//							player.getTemporaryAttributtes().remove("delete_pin");
//							player.setSetPin(true);
//							return;
//						}
//					}
//				}
...
//						}
//						player.closeInterfaces();
//						player.packets().sendMessage("The bank pin you entered was not correct.");
...
//							player.getOpenBankPin()[i] = 0;
//						}
//						player.packets().sendMessage("You have entered your bank pin successfully.");
//						player.getTemporaryAttributtes().remove("open_last");
//						player.getTemporaryAttributtes().remove("open_bank");
//						player.openPin = true;
...
//						player.packets().sendMessage("Please enter a new bank pin number.");
//						player.getTemporaryAttributtes().remove("change_last");
//						player.getTemporaryAttributtes().remove("change_pin");
//						player.interfaces().sendInterface(13);
//						player.packets().sendConfigByFile(1010, -1);
