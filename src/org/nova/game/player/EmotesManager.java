...
public final class EmotesManager implements Serializable {
                ...
                if (!unlockedEmotes.contains(id)) {
                        ...
                        if (id == 0) {//Yes
                                ...
                                case 19710: // Master dungeoneering cape
                                         ...
                                         * new NPC(-1, new Location(player.getX(), player.getY()
                                         ...
                                         * Location(player.getX()+1, player.getY()-1,
                                         ...
                                         * Location(player.getX(), player.getY()-1,
                                ...
                                case 20765: // Classic cape
                                        ...
                                        break;
                                case 20767: // Max cape
                                        int size = NPCDefinition.get(1224).size;
                                        Location spawnTile = new Location(
                                                        new Location(player.getX() + 1, player.getY(),
                                                                        player.getZ()));
                                        if (!Game.canMoveNPC(spawnTile.getZ(),
                                        ...
                                        final Location npcTile = spawnTile;
                                        WorldTasksManager.schedule(new WorldTask() {
                                                private int step;
                                                private NPC npc;
                                ...
                                case 20771: // Compl cape
                                        if (!Game.canMoveNPC(player.getZ(), player.getX(),
                                                        player.getY(), 3)) {
                                                player.packets()
                                                                .sendMessage(
                                                                                "Need more space to perform this skillcape emote.");
                                        ...
                                        WorldTasksManager.schedule(new WorldTask() {
                                                ...
                                                public void run() {
                                                        if (step == 0) {
                                                                ...
                                                                player.packets().sendCameraShake(3, 25, 50,
                                                                                25, 50);
                                                        } else if (step == 5) {
	...
	public void refreshListConfigs() {
		...
		if (unlockedEmotes.contains(45))
			value2 += 32768;
		if (value2 > 0)
			player.packets().sendConfig(313, value2); // events emotes
	}
