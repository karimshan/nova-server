...
import org.nova.game.player.content.dungeoneering.rooms.BossRoom;
import org.nova.game.player.content.dungeoneering.rooms.HandledRoom;
import org.nova.game.player.content.dungeoneering.rooms.NormalRoom;
import org.nova.game.player.content.dungeoneering.rooms.RoomEvent;
import org.nova.game.player.content.dungeoneering.rooms.StartRoom;
	...
	new BossRoom[] {
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(DungeonManager dungeon,
					...
					Player p = Game.getPlayer(dungeon.getParty().getLeader());
					int id = getBossId(1,
								level*2,
								"Gluttonous behemoth");
			...
			new BossRoom(new RoomEvent() {
				...
				//	World.spawnNPC(id, new Location(reference.getX(), reference.getY(), 0), -1, true, true);
