...
public class Cooking extends Action {
	...
	public Cooking(GlobalObject object, Item item, int amount) {
		this.amount = amount;
		this.item = item;
		this.object = object;
	}
	...
	public boolean start(Player player) {
		...
		if (cook.isFireOnly() && !object.defs().name.equals("Fire")) {
	...
	public int processWithDelay(Player player) {
		amount--;
		player.setNextAnimation(object.defs().name.contains("fire") ? FIRE_COOKING : RANGE_COOKING);
