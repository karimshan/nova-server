...
public enum SummonTrainscroll {
	...
	CALL_TO_ARMS_SCROLL(12443, 34, 0.7, new Item(12818)),//Need To Add 12781, 12798, 12814
	...
	PETRIFYING_GAZE_SCROLL(12458, 43, 0.9, new Item(12095)),//TODO need to add 12097, 12099, 12101, 12103, 12105, 12107
	...
	MANTIS_STRIKE_SCROLL(12459, 75, 3.7, new Item(12011)),
	...
	TITANS_CONSTITUTION_SCROLL(12824, 79, 7.9, new Item(12802)),//TODO add 12806, and 12804
	...
	BOIL_SCROLL(12834, 89, 8.9, new Item(12786)),
	 ...
	 */
	public static SummonTrainscroll get(int itemId) {
	 ...
	 * The mapping.
	 */
	private static final Map<Integer, SummonTrainscroll> SCROLLS = new HashMap<Integer, SummonTrainscroll>();
	
	/**
	 * Populate the mapping.
	 */
	static {
		for (SummonTrainscroll scroll : SummonTrainscroll.values()) {
	 ...
	 * @param pouch The pouch item to transform.
	 */
	private SummonTrainscroll(int itemId, int levelRequired, double experience, Item pouch) {
		this.itemId = itemId;
