...
public class EssenceMining extends Action {
	...
	private GlobalObject rock;
	private EssenceDefinitions definitions;

	private int emoteId;
	private int pickaxeTime;

	public EssenceMining(GlobalObject rock, EssenceDefinitions definitions) {
		this.rock = rock;
	...
	private void addOre(Player player) {
		...
		String oreName = ItemDefinition
				.get(definitions.getOreId()).getName()
				.toLowerCase();
		player.packets().sendMessage("You mine some " + oreName + ".",
				true);
	}

	private boolean checkRock(Player player) {
		return Game.getRegion(rock.getRegionId()).containsObject(rock.getId(),
				rock);
	}
