...
public class Spiritterrorbird extends Familiar {
	...
	public Spiritterrorbird(Player owner, Pouches pouch, Location tile,
	...
	public boolean submitSpecial(Object object) {
		...
		if (newLevel > getOwner().getSkills().getLevelFromXP(Skills.AGILITY) + 2)
			newLevel = getOwner().getSkills().getLevelFromXP(Skills.AGILITY) + 2;
