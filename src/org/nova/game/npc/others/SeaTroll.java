 ...
 * @author Owner
 */
public class SeaTroll extends NPC {

    public SeaTroll(int id, Location tile, int mapAreaNameHash,
	...
	Player killer = (Player) source;
    	...
    	Underwater.leaveUnderwater(killer);
    	CamelotKnight.sendReward(killer);     
    	final NPC n = this;
        WorldTasksManager.schedule(new WorldTask() {
