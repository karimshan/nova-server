...
public final class TormentedDemon extends NPC implements Serializable {
	
	private static final long serialVersionUID = 1525789850772953631L;
	...
	public TormentedDemon(int id, Location tile, int mapAreaNameHash,
	...
	private void sendRandomProjectile() {
		Location tile = new Location(getX() + Misc.random(7), getY()
				+ Misc.random(7), getZ());
		setNextAnimation(new Animation(10918));
		Game.sendProjectile(this, tile, 1887, 34, 16, 40, 35, 16, 0);
