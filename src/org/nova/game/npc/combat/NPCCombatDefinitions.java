...
public class NPCCombatDefinitions {
	...
	/**
	 * Everything below is @author K-Shan
	 * @return
	 */
	
	/**
	 * Returns if the npc can attack through prayer or not.
	 * @return
	 */
	public boolean canAttackThroughPrayer() {
		return canAttackThroughPrayer;
	}
	
	/**
	 * Sets whether the npc can attack through prayer or not.
	 * @param canAttackThroughPrayer
	 */
	public void setCanAttackThroughPrayer(boolean canAttackThroughPrayer) {
		this.canAttackThroughPrayer = canAttackThroughPrayer;
	}

	public double getMagicDamageModifier() {
		return magicDamageModifier;
	}

	public void setMagicDamageModifier(double magicDamageModifier) {
		this.magicDamageModifier = magicDamageModifier;
	}
	...
	public void setMeleeDamageModifier(double meleeDamageModifier) {
		this.meleeDamageModifier = meleeDamageModifier;
	}

	public double getRangeDamageModifier() {
		return rangeDamageModifier;
	}

	public void setRangeDamageModifier(double rangeDamageModifier) {
		this.rangeDamageModifier = rangeDamageModifier;
	}

	private boolean canAttackThroughPrayer;
	
	private double meleeDamageModifier, magicDamageModifier, rangeDamageModifier;
