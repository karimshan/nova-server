	...
	public int attack(NPC npc, Entity target) {
		...
		case 0: // Melee
			if (npc.withinDistance(target, 3)) {
				...
				Game.sendProjectile(npc, target, 393, 28, 16, 35, 35, 16, 0);
		...
		case 1: // Dragon breath
			...
			break;
		case 2: // Range
			damage = Misc.getRandom(250);
			npc.setNextAnimation(new Animation(13155));
			Game.sendProjectile(npc, target, 2707, 28, 16, 35, 35, 16, 0);
			delayHit(npc, 1, target, getRangeHit(npc, damage));
			break;
		case 3: // Ice arrows range
			damage = Misc.getRandom(250);
			npc.setNextAnimation(new Animation(13155));
			Game.sendProjectile(npc, target, 369, 28, 16, 35, 35, 16, 0);
			delayHit(npc, 1, target, getRangeHit(npc, damage));
			break;
		case 4: // Orb crap
			break;
