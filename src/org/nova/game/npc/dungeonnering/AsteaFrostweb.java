...
public final class AsteaFrostweb extends NPC {
	...
	public AsteaFrostweb(int id, Location tile, DungeonManager dungeonManager,
	...
	public void spawnSpider() {
		...
		for (int tryI = 0; tryI < 10; tryI++) {
			Location tile = new Location(this, 2);
			if (Game.canMoveNPC(0, tile.getX(), tile.getY(), 1)) {
...
public AsteaFrostweb(int id, Location tile, DungeonManager manager,
		RoomReference reference) {
	super(id, tile, -1, true, true);
